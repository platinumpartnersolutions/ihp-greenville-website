...
redirectLines.push("");
redirectLines.push("# 301 redirect — digestive-issues â†’ ibs-gut-issues");
...
redirectLines.push("/contact  /contact/  301");
redirectLines.push("/blog/:slug  /blog/:slug/  301");
redirectLines.push("/services/:slug  /services/:slug/  301");
redirectLines.push("/conditions/:slug  /conditions/:slug/  301");
redirectLines.push("/functional-medicine-greenville-sc  /functional-medicine-greenville-sc/  301");
redirectLines.push("");
...
console.log(`\n${"â"—.repeat(50)}`);
console.log(`âœ… Build complete — ${total} files in dist/`);
