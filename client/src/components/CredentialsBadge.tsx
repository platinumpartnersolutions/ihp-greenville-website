...
import { ExternalLink, Award, Shield, GraduationCap } from "lucide-react";
  ...
  return (
    ...
    >
      <motion.div variants={fadeInUp} className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 className="font-heading text-lg font-semibold text-foreground">Credentials & Licensing</h3>
          <p className="text-sm text-muted-foreground">Verified certifications for your peace of mind</p>
        </div>
      </motion.div>
