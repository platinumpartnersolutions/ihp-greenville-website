...
import { Phone, ChevronRight, MapPin, Clock, Star } from "lucide-react";
            ...
            >
              ...
              <motion.div variants={fadeInUp} className="flex flex-wrap gap-4 mb-16">
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-primary text-white px-6 py-3 rounded-full font-heading font-semibold shadow-lg hover:shadow-xl transition-all"
                >
              ...
              <motion.section variants={fadeInUp} className="bg-card rounded-2xl p-8 md:p-12 mb-16">
              ...
              <motion.section variants={fadeInUp} className="bg-primary/5 rounded-2xl p-8 md:p-12 mb-16">
