...
const conditions: ConditionData[] = [
...

  {
    ...
    content: {
      definition: "The defining feature of sciatica is that the pain doesn't stay in one place. It starts in the lower back or deep in the buttock, then travels — down through the hip, into the back of the thigh, sometimes all the way to the foot. That radiating pattern follows the sciatic nerve, the longest nerve in the body.\n\nSciatica is a symptom, not a diagnosis. The nerve is compressed or irritated somewhere along its path — most often by a herniated lumbar disc at L4 or L5, spinal stenosis, or piriformis syndrome, where the piriformis muscle presses directly on the nerve. Identifying where and why the compression is occurring is the only way to treat it effectively rather than just managing the pain it produces.",
      symptoms: [
...

  {
    ...
    content: {
      definition: "Most athletes don't come in the first time an injury happens. They come in when it keeps happening — or when a nagging overuse problem has finally crossed from 'I can train through this' to 'I can't train at all.'\n\nSports injuries split into two categories: acute (sprains, strains, tears — sudden force exceeding tissue tolerance) and overuse (tendinopathy, bursitis, stress fractures — repetitive load that exceeds recovery capacity). Both respond well to the right combination of acupuncture and dry needling. And both have systemic factors — sleep, nutrition, inflammatory state — that determine how quickly tissue heals and whether it holds up under future training demand.",
      symptoms: [
...

  {
    ...
    content: {
      definition: "PTSD isn't just memories that won't stay in the past. It's a nervous system that has been rewired by experience — specifically by something overwhelming enough that the brain's threat-response circuitry got stuck in an activated state and hasn't fully recovered.\n\nThe amygdala reads ordinary sensory input as threat signals. The prefrontal cortex — which normally inhibits those signals — can't override them reliably. The result is hypervigilance, disrupted sleep, and intrusive re-experiencing that isn't a choice or a failure to move on. It's a measurable neurological state.\n\nPTSD is not limited to combat veterans. Car accidents, medical trauma, childhood abuse, sudden loss — any experience that overwhelmed the brain's processing capacity can leave this neurological residue. The common thread is a dysregulated autonomic nervous system that hasn't returned to baseline.",
      symptoms: [
...

  {
    ...
    content: {
      definition: "The gut wall isn't a passive membrane. It's a selective barrier — one cell layer thick in places — controlled by tight junction proteins that regulate what enters the bloodstream and what stays in the intestinal lumen. When those junctions open inappropriately, bacteria, toxins, and partially digested food particles cross into circulation. The immune system responds to what it encounters there.\n\nThe result isn't always digestive symptoms. Brain fog. Joint pain. Skin eruptions. Fatigue. Autoimmune flares. These are frequent downstream presentations of intestinal permeability — conditions affecting organs with no obvious connection to the gut, driven by the systemic immune activation that a compromised gut barrier produces. The medical literature firmly establishes intestinal permeability as real, measurable, and treatable.",
      symptoms: [
...

  {
    ...
    categorySlug: "neurological-mental-health",
    metaTitle: "Cognitive Decline & Alzheimer's Prevention | Greenville, SC — IHP",
    ...
    content: {
      definition: "Cognitive decline — the gradual loss of memory, reasoning, language, and executive function — is not an inevitable consequence of aging. Emerging research over the past two decades has established that Alzheimer's disease and most forms of dementia have identifiable, addressable biological drivers that begin disrupting brain function decades before symptoms appear. The window for meaningful intervention is wide and early. At Integrative Health Partners, Dr. Hendry's functional medicine approach to cognitive health identifies the specific metabolic, inflammatory, hormonal, vascular, and nutritional factors that impair brain function and accelerates cognitive aging — then addresses them systematically. This is not a memory supplement protocol. It is a comprehensive biological investigation.\n\nMild cognitive impairment (MCI) sits between normal age-related forgetfulness and diagnosable dementia — and represents the highest-leverage intervention point. Patients noticing consistent word-finding difficulty, short-term memory lapses that have worsened over months or years, or cognitive fatigue that wasn't present five years ago are the ideal candidates for this evaluation.",
      symptoms: [
        "Progressive short-term memory loss — forgetting recent conversations, appointments, or names",
        "Word-finding difficulty — knowing what you want to say but the word won't come",
        "Slower information processing and mental fatigue with cognitive tasks",
        "Difficulty with executive function — planning, sequencing, managing finances or logistics",
        "Getting lost in familiar places or difficulty with spatial navigation",
        "Personality or mood changes — increased anxiety, irritability, or social withdrawal",
        "Difficulty following conversations or keeping track of multi-step tasks",
        "Reduced insight — not noticing the changes that family members are observing",
      ],
      ...
      drApproach: `Cognitive decline is the health concern I see patients most reluctant to address directly — partly because fear of what they might find, and partly because conventional medicine has told them nothing can be done. Both assumptions are worth questioning.\n\nFunctional medicine evaluation of cognitive health in a 55-year-old is not about diagnosing Alzheimer's — it's about finding the modifiable factors already present that are either accelerating or preventable. In practice, almost every patient who comes in with cognitive concerns has at least two or three addressable drivers: elevated homocysteine from an MTHFR variant nobody ever tested for, subclinical hypothyroidism that the TSH alone missed, blood sugar dysregulation that manifests as afternoon brain fog, sleep disruption from undiagnosed apnea, or a mercury burden from thirty years of amalgam fillings. These are not philosophical concepts — they show up on testing.\n\nThe Bredesen Protocol has brought important attention to the multi-driver nature of Alzheimer's disease. My clinical approach reflects the same framework: identify the specific biological insults present in this individual patient, address them in priority order, and monitor the response. There is no single protocol that applies to every person — the value is in the evaluation.`,
      faqs: [
        { q: "What is the Bredesen Protocol?", a: "The Bredesen Protocol (also called ReCODE — Reversal of Cognitive Decline) is a personalized, multi-modal intervention program developed by Dale Bredesen, MD, that identifies and addresses the multiple biological drivers of Alzheimer's disease. It involves comprehensive laboratory evaluation, metabolic optimization, dietary change, sleep improvement, hormonal balancing, toxin removal, and targeted supplementation — the same framework that guides Dr. Hendry's cognitive health evaluations. Clinics licensed as official Bredesen Protocol providers have specific training and certification requirements. Dr. Hendry's approach is grounded in the same evidence-based, multi-driver functional medicine framework." },
        { q: "Can Alzheimer's disease really be prevented or reversed?", a: "Prevention is well-supported by the evidence — the modifiable risk factors for Alzheimer's (insulin resistance, cardiovascular risk factors, sleep apnea, B12 and folate deficiency, heavy metal burden, thyroid dysfunction) are addressable at any age, and addressing them reduces risk measurably. Reversal of established Alzheimer's dementia is more contested, but Dr. Bredesen's published case series and the broader literature on multi-modal interventions document cognitive improvement in patients with mild to moderate cognitive impairment when underlying biological drivers are comprehensively addressed. The strongest evidence — and the greatest leverage — is in the MCI and early-decline window." },
